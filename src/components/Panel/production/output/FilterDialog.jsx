                            ...
                            <div className="flex flex-col justify-center w-[80%] gap-3">
                                ...
                                <div className="flex flex-col md:flex-row justify-between gap-3">
                                    <div className="w-full md:w-1/2">
                                        <DatePicker
                                            ...
                                            maxDate={formik.values.toProductionDate}
                                    ...
                                    <div className="w-full md:w-1/2">
                                        <DatePicker
                                        minDate={formik.values.fromProductionDate}
                                ...
                                <div className="flex flex-col md:flex-row justify-between gap-3">
                                    <div className="w-full md:w-1/2">
                                        <DatePicker
                                            placeholder="از تاریخ"
                                            maxDate={formik.values.toExpirationDate}
                                            calendarPosition={`bottom`}
                                            className="red"
                                            digits={['۰', '۱', '۲', '۳', '۴', '۵', '۶', '۷', '۸', '۹']}
                                            format={`YYYY/MM/DD`}
                                    ...
                                    <div className="w-full md:w-1/2">
                                        <DatePicker
                                        minDate={formik.values.fromExpirationDate}
                                            placeholder="تا تاریخ"
                                            calendarPosition={`bottom`}
                                            className="red"
                                            digits={['۰', '۱', '۲', '۳', '۴', '۵', '۶', '۷', '۸', '۹']}
