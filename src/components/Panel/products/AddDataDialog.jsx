...
import {useLazyGetAllUnitQuery} from "@/redux/features/category/CategorySlice";
                    ...
                    <DialogContentText style={{fontFamily: "__fonts_2f4189,__fonts_Fallback_2f4189"}}>
                        ...
                        <form className="flex justify-center " onSubmit={formik.handleSubmit} method="POST">
                            <div className="flex flex-col justify-center w-[90%] gap-5">
                                    ...
                                    </div>
                                    {
                                        isLoadingUpload ? (
                                            ...
                                            (uploadedImage !== "" && uploadedImage !== null) ? (
                                                <div>
                                                    <div
                                                        className="relative w-16 h-16 rounded border border-dashed border-[#D9D9D9]">
                                                        <button onClick={handleDeleteUpload}
                                                        ...
                                                        <img className="object-cover w-full h-full" src={uploadedImage}
                                                             alt="uploadedImage"/>
                                                    </div>
                                                </div>
                                            ) : (
                                ...
                                <div>
                                    <FormControl
                                        ...
                                        <InputLabel sx={{
                                            ...
                                            fontSize: "0.8rem",
                                            color: "#9F9F9F"
                                        }} id="demo-multiple-name-label">نوع محصولات </InputLabel>
                                        <Select
                                ...
                                {tags.length > 0 &&
                                    <div className="border rounded border-[#9F9F9F] p-2  grid grid-cols-3 gap-2">
                                        {tags.map((name) => (


                                                <div
                                                    className="border border-[#9F9F9F] px-2 py-1 rounded-full flex justify-between items-center gap-2 w-full box-border h-max">
                                                    <span className="text-xs">{name}</span>
                                                    <button onClick={(e) => {
                                                        handleFilterTags(name, e)
                                                    }} className="">
                                    ...
                                    <div className="flex flex-col">
                                        <div className="flex w-full">
                                            <div className="border border-[#D9D9D9] py-4 w-1/2 px-3">
                                                <span
                                                    className="text-[#9F9F9F] text-[0.8rem]">آیا داری تاريخ انقضا است؟</span>
                                            </div>
                                            <div className="border border-[#D9D9D9] py-4 w-1/2">
                                                <div className="flex justify-center gap-2">
                                                    <span className="text-[#9F9F9F] text-[0.8rem]">خیر</span>
                                                    <AntSwitch checked={formik.values.isExpirable} onChange={(e) => {
                                                        formik.setFieldValue("isExpirable", e.target.checked)
