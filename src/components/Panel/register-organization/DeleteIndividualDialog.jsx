                ...
                <DialogContent>
                    <DialogContentText style={{fontFamily: "__fonts_2f4189,__fonts_Fallback_2f4189"}}>
                        ...
                        <div className="flex justify-center mt-10 gap-4">
                            ...
                            <div>
                                <button onClick={props.handleCloseDeleteIndividual} className="px-6 py-2 text-[0.8rem]  rounded-[0.5rem] py-3  hover:opacity-80 font-bold bg-neutral-400 text-white">بستن</button>
                            </div>
                        </div>
                    </DialogContentText>
                </DialogContent>
