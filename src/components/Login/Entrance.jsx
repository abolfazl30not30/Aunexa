    ...
    return (
        <>
            <div className="w-[80%] md:w-[50%]">
                ...
                <div>
                    <a href={`http://194.33.125.112:32190/oauth2/authorize?response_type=code&client_id=client1&scope=openid&redirect_uri=http://194.33.125.112:32732/redirect&code_challenge=${codeChallenge}&code_challenge_method=S256`}
