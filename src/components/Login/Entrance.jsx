    ...
    return (
        <>
            <div className="w-[80%] md:w-[50%]">
                ...
                <div>
                    <a href={`https://auth.prod.vipsoftware1.com/oauth2/authorize?response_type=code&client_id=client1&scope=openid&redirect_uri=https://msc.vipsoftware1.comredirect&code_challenge=${codeChallenge}&code_challenge_method=S256`}
