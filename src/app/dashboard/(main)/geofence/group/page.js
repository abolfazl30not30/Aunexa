...
import AddDataDialog from "@/components/Dashboard/geofence/group/AddDataDialog";
import FilterDialog from "@/components/Panel/purchase-request/FilterDialog";
import MoreInfoDialog from "@/components/Dashboard/geofence/group/MoreInfoDialog";
import DeleteDialog from "@/components/Panel/purchase-request/DeleteDialog";
import Link from "next/link";
import EditInfoDialog from "@/components/Dashboard/geofence/group/EditInfoDialog";
    ...
    <>
      <div>
        <header className="flex justify-between items-center text-[0.9rem] bg-white py-6 px-5 md:px-10">
          <div className="">
            <h2 className="font-[800] text-[0.9rem] md:text-[1.1rem]">گروه</h2>
          </div>
          <div className="">
            {
              <button
              ...
              <table className=" w-full table-auto overflow-scroll border-collapse border-spacing-0 text-sm text-center text-gray70  ">
                <thead className="text-[0.9rem] text-gray80  bg-[#F8F8F8] md:bg-[#F2EDED] ">
                  <tr>
                    ...
                    <th className="table-cell px-2 md:px-6 py-4">نام گروه</th>
