...
import AddDataDialog from "@/components/Panel/production/input/AddDataDialog";
import FilterDialog from "@/components/Panel/production/input/FilterDialog";
          ...
          <div className="">
            {
              ...
              >
                <span className="hidden md:inline">ثبت ورودی</span>
                <svg
              ...
              <table className="w-full table-auto overflow-scroll border-collapse border-spacing-0 text-sm text-center text-gray70  ">
                <thead className="text-[0.9rem] text-gray80  bg-[#F8F8F8] md:bg-[#F2EDED] ">
                  <tr>
                    ...
                    <th className="px-2 md:px-6 px-6 py-4">محصول تولیدی</th>
