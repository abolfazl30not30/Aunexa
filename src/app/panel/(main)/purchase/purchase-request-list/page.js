                                    ...
                                    isDataLoading ? (
                                        ...
                                        inventoryData?.content?.map((data, index) => (
                                            <tr onClick={()=>{handleOpenMoreInfoRow(data)}} className="table-row border-b">
                                                ...
                                                <td className="px-2 md:px-6 py-4  text-gray70 whitespace-nowrap ">
                                                    {data?.requestTime}   {data?.requestDate}
                                                </td>
                                                ...
                                                <td scope="row"
                                                    ...
                                                    </button>
                                                    {
                                                            ...
                                                            <button
                                                                onClick={()=>{handleOpenConfirm(data)}}
                                                                className="border border-1 border-solid border-[#12D377] rounded p-[0.4rem] hover:bg-green-100">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                    <path d="M13.3337 4L6.00033 11.3333L2.66699 8" stroke="#12D377" stroke-linecap="round" stroke-linejoin="round"/>
                                                                </svg>
                                                            </button>
