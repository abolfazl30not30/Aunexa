...
import AddDataDialog from "@/components/Panel/equipment-store/output/AddDataDialog";
import FilterDialog from "@/components/Panel/equipment-store/output/FilterDialog";
import MoreInfoDialog from "@/components/Panel/equipment-store/output/MoreInfoDialog";
import DeleteDialog from "@/components/Panel/equipment-store/output/DeleteDialog";
import Link from "next/link";
import EditInfoDialog from "@/components/Panel/equipment-store/output/EditInfoDialog";
import {useSelector} from "react-redux";
import {useGetAllESOQuery} from "@/redux/features/equipment-store/output/ESOapiSlice";
...
function primaryStoreInput() {
    ...
    const {data: inventoryData = [], isLoading: isDataLoading, isError: isDataError} = useGetAllESOQuery({page,sort,filterItem},{ refetchOnMountOrArgChange: true })
        ...
        <>
            <div>
                <header className="flex justify-between items-center text-[0.9rem] bg-white py-6 px-5 md:px-10">
                    <div className="">
                        <h2 className="font-[800] text-[0.9rem] md:text-[1.1rem]">انبار تجهیزات / بخش خروجی</h2>
                    </div>
                    <div className="">
                        {
                                <button
                                    ...
                                    <span className="hidden md:inline">ثبت تجهیزات خروجی</span>
                ...
                <section className="py-4 md:px-8 mt-5 bg-white h-[50rem]">
                    <div className="px-4 flex justify-end">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                <button onClick={handleOpenSortMenu}
                                        className="flex items-center gap-2 text-[0.9rem] text-gray9F border border-1 border-solid border-borderGray rounded px-2 md:px-4 py-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none">
                                        <path d="M6 12H18M3 6H21M9 18H15" stroke="#9F9F9F" stroke-width="1.5"
                                    ...
                                    isDataLoading ? (
                                        ...
                                        inventoryData?.content?.map((data, index) => (
                                            <tr onClick={()=>{handleOpenMoreInfoRow(data)}} className="table-row border-b">
                                                ...
                                                <td scope="row"
                                                    className="hidden md:flex gap-2 px-6 py-4 justify-center text-gray70 whitespace-nowrap ">
                                                    <button onClick={()=>{handleOpenMoreInfo(data)}}
                                                            className="border border-1 border-solid border-gray70 rounded p-[0.4rem] hover:bg-neutral-100">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                             viewBox="0 0 18 18" fill="none">
                                                            <path d="M9 4.56442V4.55554" stroke="#797979"
                                                                  stroke-linecap="round" stroke-linejoin="round"/>
                                                            <path d="M9 13.4445V7.22223" stroke="#797979"
                                                                  stroke-linecap="round" stroke-linejoin="round"/>
                                                            <path
                                                                d="M9 17C13.4183 17 17 13.4183 17 9C17 4.58172 13.4183 1 9 1C4.58172 1 1 4.58172 1 9C1 13.4183 4.58172 17 9 17Z"
                                                                stroke="#797979" stroke-linecap="round"
                                                                stroke-linejoin="round"/>
                                                        </svg>
                                                    </button>
                                                    {
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                    ...
                                                                    <g clip-path="url(#clip0_197_250)">
                                                                        <path
                                                                            ...
                                                                            stroke="#2492FF" stroke-linecap="round"
                                                                            stroke-linejoin="round"/>
                                                                    </g>
                                                                    <defs>
                                                            ...
                                                            <button onClick={() => {handleOpenDelete(data.id)}}
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        stroke="#FE4949" stroke-linecap="round"
                                                                        stroke-linejoin="round"/>
                                                                </svg>
                                                            </button>
