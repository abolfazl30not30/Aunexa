              ...
              <table className=" w-full table-auto overflow-scroll border-collapse border-spacing-0 text-sm text-center text-gray70  ">
                <thead className="text-[0.9rem] text-gray80  bg-[#F8F8F8] md:bg-[#F2EDED] ">
                  <tr>
                    ...
                    <th className="px-2 md:px-6 px-6 py-4">کد</th>
                  ...
                  {isDataLoading
                    ...
                    : productData?.content?.map((data, index) => (
                        <tr
                          ...
                          className="table-row border-b flex items-center"
                        >
                          <td className="hidden md:table-cell px-6 py-4  text-gray70 whitespace-nowrap ">
                            {index + 1}
                          </td>
                          ...
                          <td
                            scope="row"
                            className="px-2 md:px-6 py-8 flex justify-center  text-gray70 whitespace-nowrap "
                          >
                            {data?.isExpirable ? (
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
