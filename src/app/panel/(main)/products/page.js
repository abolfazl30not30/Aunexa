    ...
    return (
        <>
            <div>
                                                    ...
                                                    {data?.isExpirable ? (
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="#12D377" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round"/>
                                                        </svg>
                                                    ) : (
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="#DB3746" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round"/>
                                                        </svg>
                                                    )}
                                                </td>
                ...
                <MoreInfoDialog handleOpenDelete={handleOpenDelete} handleOpenEditInfo={handleOpenEditInfo}
                                moreInfoTarget={moreInfoTarget} openMoreInfo={openMoreInfo}
                                handleCloseMoreInfo={handleCloseMoreInfo}/>
                <DeleteDialog deleteTargetId={deleteTargetId} openDelete={openDelete}
                              handleCloseDelete={handleCloseDelete}/>
                <EditInfoDialog editInfoTarget={editInfoTarget} handleCloseEditInfo={handleCloseEditInfo}
