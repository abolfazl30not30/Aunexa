...
function primaryStoreInput() {
    ...
    const {data: inventoryData = [], isLoading: isDataLoading, isError: isDataError} = useGetAllPSOQuery({page,sort,filterItem},{ refetchOnMountOrArgChange: true })
        ...
        <>
            <div>
                <header className="flex justify-between items-center text-[0.9rem] bg-white py-6 px-10">
                    <div className="">
                        <h2 className="font-[800] text-[0.9rem] md:text-[1.1rem]">انبار مواد اولیه / بخش خروجی</h2>
                    </div>
                    <div className="">
                        {
                                <button
