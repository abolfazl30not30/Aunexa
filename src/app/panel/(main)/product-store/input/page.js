...
import AddDataDialog from "@/components/Panel/product-store/input/AddDataDialog";
import FilterDialog from "@/components/Panel/product-store/input/FilterDialog";
import MoreInfoDialog from "@/components/Panel/product-store/input/MoreInfoDialog";
import DeleteDialog from "@/components/Panel/product-store/input/DeleteDialog";
import Link from "next/link";
import EditInfoDialog from "@/components/Panel/product-store/input/EditInfoDialog";
import {useSelector} from "react-redux";
import {useGetAllPOSIQuery} from "@/redux/features/product-store/input/POSIapiSlice";
...
function primaryStoreInput() {
    ...
    const {data: inventoryData = [], isLoading: isDataLoading, isError: isDataError} = useGetAllPOSIQuery({page,sort,filterItem},{ refetchOnMountOrArgChange: true })
                    ...
                    <div className="">
                        {
                                <button
                                    ...
                                    <span className="hidden md:inline">ثبت محصولات ورودی</span>
