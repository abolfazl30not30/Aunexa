...
import {date} from "yup";
 ...
 function Dashboard() {
    ...
    //     })
    // }
     const { data : inventoryData   = [], isLoading:isDataLoading , isError:isDataError } = useGetAllQuery(page)
        ...
        <>
            <div>
               <header className="flex justify-between items-center text-[0.9rem] bg-white py-6 px-10">
                   ...
                   <div className="">
                       <button className="flex bg-mainRed text-white items-center text- px-3 py-2 rounded-full md:rounded" onClick={handleOpenAddData}>
                ...
                <section className="py-4 md:px-8 mt-5 bg-white h-[50rem]">
                    <div className="px-4 flex justify-between">
                        ...
                        <div className="flex gap-3">
                            <button onClick={handleOpenFilter} className="flex items-center gap-2 text-[0.9rem] text-gray9F border border-1 border-solid border-borderGray rounded px-2 md:px-4 py-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <tbody className='table-body'>
                                {
                                    ...
                                    <span className="text-[0.8rem] bg-greenBg text-greenText py-1 px-2 rounded-xl">
                                        تاييد شده
                                            ...
                                            <td scope="row" className="hidden md:flex gap-2 px-6 py-4 justify-center text-gray70 whitespace-nowrap ">
                                                <button onClick={handleOpenMoreInfo} className="border border-1 border-solid border-gray70 rounded p-[0.4rem] hover:bg-neutral-100">
                                                ...
                                                <button onClick={()=>{handleOpenDelete(data.id)}} className="border border-1 border-solid border-[#FE4949] rounded p-[0.4rem] hover:bg-red-100">
                                                    <svg  xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <MoreInfoDialog openMoreInfo={openMoreInfo} handleCloseMoreInfo={handleCloseMoreInfo}/>
