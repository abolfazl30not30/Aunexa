        ...
        <>
            <div>
               <header className="flex justify-between items-center text-[0.9rem] bg-white py-6 px-10">
                            ...
                            <table className=" w-full table-auto overflow-scroll border-collapse border-spacing-0 text-sm text-center text-gray70  ">
                                ...
                                <tr className="border-b" >
                                    ...
                                    <td scope="row" className="hidden md:flex gap-2 px-6 py-4 justify-center text-gray70 whitespace-nowrap ">
                                        ...
                                        <button onClick={handleOpenDelete} className="border border-1 border-solid border-[#FE4949] rounded p-[0.4rem] hover:bg-red-100">
                                            <svg  xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <DeleteDialog openDelete={openDelete} handleCloseDelete={handleCloseDelete} />
            </div>
        </>
    )
}
